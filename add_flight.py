...
from db import add_flight
from keyboards import BTN_ADD_FLIGHT, main_menu_keyboard
from states import AddFlightStates
from formatters import fmt_flight_saved
from time_utils import minutes_to_hhmm, parse_time, today_iso
...
async def add_flight_night_time(message: Message, state: FSMContext) -> None:
    ...
    logger.info(
        ...
        user_id, data["destination"], flight_minutes, night_minutes,
    )
